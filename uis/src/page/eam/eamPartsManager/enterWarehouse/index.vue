<template>
  <div>
    ...
    <div class="queryBodys">
      <el-form ref="ruleForm" style="width:700px;" label-suffix="：" label-position="right" size="mini"  label-width="80px" :inline-message="true" :status-icon="true" class="demo-ruleForm">
        ...
        <el-form-item label="入库类型">
          <el-radio-group v-model="queryBean.inBoundTypes" @change="getTableData()">
            <el-radio border label="ALL">全部</el-radio>
    ...
    <div>
      <el-table :data="tableData" resizable border :row-class-name="tableRowClassName"
        ...
        <el-table-column prop="wareHouseCode" label="入库编号" min-width="100" sortable show-overflow-tooltip align="center">
        ...
        <el-table-column prop="supplier" label="供应商" sortable show-overflow-tooltip align="center"></el-table-column> -->
        <el-table-column prop="amount" label="数量" min-width="70" sortable show-overflow-tooltip align="center"></el-table-column>
        <el-table-column prop="price" label="单价" min-width="70" sortable show-overflow-tooltip align="center"></el-table-column>
        <el-table-column prop="unit" label="单位" min-width="70" sortable show-overflow-tooltip align="center"></el-table-column>
        <el-table-column prop="totalPrice" label="总价" min-width="90" sortable show-overflow-tooltip align="center"></el-table-column>
        <el-table-column prop="status" label="任务状态" min-width="110" sortable show-overflow-tooltip align="center">
          <template slot-scope="scope">
            <div slot="reference">
        ...
        <el-table-column prop="reviewer" label="审核人" min-width="100" sortable show-overflow-tooltip align="center"></el-table-column>
      </el-table>
      <div style="text-align:right;">
        <el-pagination :current-page.sync="queryBean.page" @current-change="changePage"
          :page-size="queryBean.size" layout="total, prev, pager, next" :total="queryBean.totalCount"></el-pagination>
      </div>
    </div>
    </el-card>
  </div>
