<template>
  <div>
    <el-table :data="tableData" resizable  highlight-current-row border @row-dblclick="handleClick"
      ...
      <!-- <el-table-column prop="supplier" label="供应商" width="110" sortable show-overflow-tooltip align="center"></el-table-column> -->
      ...
      <el-table-column prop="totalPrice" label="总价" min-width="80" sortable show-overflow-tooltip align="center"></el-table-column>
      <el-table-column fixed="right" label="操作" min-width="145" sortable show-overflow-tooltip align="center" v-if="flag">
