  ...
  <div class="cardHeight">
    <div class="fromHeight" style="margin: 0px 0px;">
        ...
        <div class="queryBodys">
          <el-form ref="ruleForm" style="width:700px;" label-suffix="：" label-position="left" size="mini"
            ...
            <el-form-item label="出库类型">
              <el-radio-group v-model="queryBean.outBoundType" @change="getTableData()">
                <el-radio border label="ALL">全部</el-radio>
      ...
      <div class="operatorHeight" style="float:right;">
        <el-button type="primary" icon="el-icon-plus" class="buttonHeight" :size="GlobalCss.controlSize"
          @click="handleAdd()">新增</el-button>
        <el-button type="success" icon="el-icon-download" class="buttonHeight" :size="GlobalCss.controlSize"
        ...
        <el-table-column prop="status" label="任务状态" sortable align="center" width="110">
          <template slot-scope="scope">
            <div slot="reference">
              ...
              <el-tag size="mini" v-else-if="(scope.row.status  === '已结束')" type="success">{{ scope.row.status}}
              </el-tag>
