<template>
  <div>
    <el-table :data="tableData"  resizable highlight-current-row border @row-dblclick="handleClick" :max-height="tableHeight"
      ...
      <el-table-column prop="norm" label="规格型号" width="110"  align="center"></el-table-column>
      <el-table-column prop="leaveFactoryCode" label="出厂编号" width="130"  align="center"></el-table-column>
