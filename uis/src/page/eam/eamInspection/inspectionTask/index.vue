  ...
  <div class="cardHeight">
    <div class="fromHeight">
        <div style="float:left;margin-bottom:5px;">
          <el-form :model="form">
            <el-input :size="GlobalCss.controlSize" v-model="form.query" placeholder="请输入任务编码或者任务名称">
      ...
      <template>
        <el-table :data="tableData" border ref="multipleTable" resizable highlight-current-row class="tableHeight"
          :max-height="htable" :size="GlobalCss.buttonSize">
          ...
          <el-table-column fixed="left" prop="inspTaskCode" label="任务编号" width="200" align="center"> </el-table-column>
          <el-table-column prop="inspTaskName" label="任务名称" width="200" align="center"> </el-table-column>
          ...
          <el-table-column prop="startDate" label="开始时间" width="120" :show-overflow-tooltip="true" align="center">
          </el-table-column>
          <el-table-column prop="overDate" label="结束时间" width="120" align="center"> </el-table-column>
          <el-table-column prop="responsibleDept" label="责任部门" width="150" align="center"> </el-table-column>
          <el-table-column prop="responsiblePerson" label="责任人" width="120" align="center"> </el-table-column>
        ...
        <el-pagination class="pageHeight" style="float:right;" background :current-page.sync="form.page"
