...
<div>
  ...
  <el-form :model="ruleForm" :rules="rules" ref="ruleForm" style="width:700px;"  label-width="100px" :inline-message="true" :status-icon="true" class="demo-ruleForm">
  ...
  <el-collapse-item title="检修记录" name="rep">
      <el-table :data="reps" border :size="GlobalCss.buttonSize">
      </el-table>
