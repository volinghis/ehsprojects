        ...
        <div class="queryBodys">
          <el-form ref="queryForm"
            ...
            <el-form-item label="缺陷状态">
              <el-radio-group v-model="queryBean.status"
                              @change="initTable()">
                <el-radio border
                          label="ALL">全部</el-radio>
                <el-radio border
                          label="OK">已处理</el-radio>
                <el-radio border
                          label="ERROR">未处理</el-radio>
              </el-radio-group>
            </el-form-item>
            <el-form-item label="缺陷等级">
              <el-radio-group v-model="queryBean.level"
                              @change="initTable()">
                <el-radio border
                          label="ALL">全部</el-radio>
                <el-radio border
                          label="NORMAL">一般缺陷</el-radio>
                <el-radio border
                          label="MAJOR">重大缺陷</el-radio>
              </el-radio-group>
            </el-form-item>
          </el-form>
        </div>
            ...
            <el-table-column prop="objectKey"
              ...
              <template slot-scope="scope">
                <el-link type="primary"
                         @click="handleLinkClick(scope.row)">{{scope.row.objectKey}}</el-link>
              </template>
            </el-table-column>
