  ...
  <div>
    <el-row>
      <el-col :span="4"
        ...
        <el-tabs v-model="queryBean.objectType"
      ...
      <el-col :span="20">
        <div class="queryBodys">
          <el-form ref="queryForm"
                   ...
                   :inline-message="true"
                   :status-icon="true"
                   class="demo-queryForm">
            <el-form-item label="检修结论">
              <el-radio-group v-model="queryBean.result"
                              @change="initTable()">
                <el-radio border
                          label="ALL">全部</el-radio>
                <el-radio border
                          label="OK">已解决</el-radio>
                <el-radio border
                          label="ERROR">未解决</el-radio>
              </el-radio-group>
            </el-form-item>
            <el-form-item label="检修执行人">
              <el-radio-group v-model="queryBean.userType"
                              @change="initTable()">
                <el-radio border
                          label="ALL">全部</el-radio>
                <el-radio border
                          label="OWNER">我检修的</el-radio>
                <el-radio border
                          label="OUTER">外部人员</el-radio>
              </el-radio-group>
            </el-form-item>
          </el-form>
        </div>
            ...
            <el-table-column prop="result"
              ...
              <template slot-scope="scope">
                <el-tag :type="scope.row.result === 'OK' ? 'success' : 'danger'"
                        disable-transitions>{{ scope.row.result === 'OK' ? '已解决' : '未解决' }}</el-tag>
              </template>
            </el-table-column>
          </el-table>
        </div>
        <div class="tableFooter">
          <div class="pagination">
            <el-pagination background
                           ...
                           :current-page="queryBean.page"
                           :page-size="queryBean.size"
