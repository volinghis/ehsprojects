<template>
  <div>
    ...
    <div class="loginBody">
      <el-row>
        <el-col :span="12">
          ...
          <p>
            <span>东恒鑫源智能仓储管理系统</span><br>
            <span>DongHeng XinYuan Intelligent WareHouse Management System</span>
          </p>
        </el-col>
        <el-col :span="12">
    ...
    <div class="footerBody">
      <p><span>Copyright © DongHengSoft, All Rights Reserved.<br>西安东恒鑫源软件开发有限公司</span></p>
    </div>
  </div>
</template>
<script>
