...
public interface EamLedgerDao extends JpaRepository<EamLedger, String>  {
	...
	@Query(" select el from EamLedger el where el."+EamLedger.DEVICE_NUM+" like %?1%  and el."+EamLedger.DATA_MODEL+"<>'"+DataConfig.UNSHOW_DATA_STATE+"' order by "+BaseEntity.CREATION_TIME+" desc")
